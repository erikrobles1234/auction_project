...
<div class="row">
  <div class="spec_col">
    <div class="spec_card">
      <form action="buy_hallucinogenics_filter.jsp">
...
<%
     ...
     try {
             ...
             String str = "SELECT * FROM ebay.auction JOIN ebay.narcotics ON auction.drug_id = narcotics.drug_id JOIN ebay.hallucinogens ON narcotics.drug_id = hallucinogens.drug_id";
             ...
             //make a column
             out.print("<td>");
             out.print("Natural/Synthetic");
             out.print("</td>");
             //make a column
             out.print("<td>");
             out.print("Hall. Strength");
             out.print("</td>");
             //make a column
             out.print("<td>");
             ...
             while (result.next()) {
                     ...
                     out.print("</tr>");
                     //Print out current price
                     out.print(result.getString("natsynth"));
                     out.print("</td>");
                     out.print("</tr>");
                     //Print out current price
                     out.print(result.getString("hallstrength"));
                     out.print("</td>");
                     out.print("</tr>");
                     //Print out current price
